...
uniform bool use_shade_texture = true;
...
void light()
{
	...
	if(use_shade_texture == false)
	{
		shade = texture(base_texture, UV).rgba * shade_color.rgba;
	}
